...
// @deno-types="../modules/lib/components/label.d.ts"
import * as LabelPrimitive from '../modules/esm.sh/v132/_@radix-ui/react-label@2.0.2.js'
import * as LabelTypes from "../modules/lib/components/label.d.ts"
...
const Label = React.forwardRef<
  ElementRef<typeof LabelTypes.Root>,
  ComponentPropsWithoutRef<typeof LabelTypes.Root>
